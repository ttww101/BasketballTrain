...
class TrainVC: NavbaritemVC {
    ...
    override func viewDidLoad() {
        ...
        listData = [
            ...
            TrainModel(title: "运球训练", imageName: "crossover", secondTitle: "Crossover"),
            TrainModel(title: "上篮训练", imageName: "layup", secondTitle: "Layup"),
            TrainModel(title: "投篮训练", imageName: "shooting", secondTitle: "Shooting")
        ]
