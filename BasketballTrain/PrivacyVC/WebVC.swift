...
class PrivacyWebVC: UIViewController, WKNavigationDelegate {
    ...
    init(titleP:String, urlP:[String]?) {
        super.init(nibName: nil, bundle: nil)
        self.modalPresentationStyle = UIModalPresentationStyle.overCurrentContext
        titleDesccnentt = titleP
        if (urlP != nil) {
            multiUrlcnentt = urlP!
        }
    }
    ...
    func setCallBackByPrivacy(sdadf: String?, efqev: String?, pijfjgq: String?, showOff: (() -> Void)?) {
        callbackcnentt = showOff
    }
